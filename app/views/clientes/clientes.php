...
<head>
    ...
    <style>
        /* --- ESTILOS ADICIONALES PARA GESTIÓN DE CLIENTES --- */
        /* Estos estilos complementan dashboard.css manteniendo coherencia visual */

        /* SECCIÓN DE CLIENTES - GRID (misma estructura que proveedores) */
        .providers-section {
            display: grid;
        ...
        /* TABLA DE CLIENTES - ESTILO COHERENTE CON DASHBOARD */
        .table-container {
            overflow-x: auto;
        }
                            ...
                            <?php if (!empty($clientes)): ?>
                                <?php foreach ($clientes as $p): ?>
                                    <tr>
                                        <td>
                                            <div class="user-name-display">
                                                <div class="user-avatar">
                                                    ...
                                                    <?= strtoupper(substr(htmlspecialchars($p['nombre'] ?? 'C'), 0, 1)) ?>
                                                </div>
                                                <span><?= htmlspecialchars($p['nombre'] ?? 'Sin Nombre') ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge badge-operator">
                                                <?= htmlspecialchars($p['cedula'] ?? 'N/A') ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?= htmlspecialchars($p['direccion'] ?? 'N/A') ?>
                                        </td>
                                        <td>
                                            <div class="actions-cell">
                                                <a href="index.php?controller=cliente&action=formeditarcliente&id=<?= $p['id_cliente'] ?? $p['id'] ?? '' ?>" 
