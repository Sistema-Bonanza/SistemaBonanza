...
<head>
    ...
    <title>Nueva Categoría · POS & Inventario</title>
...
<body>
    ...
    <main class="main">
        ...
        <div class="welcome-card">
            ...
            <p>Registra una nueva categoría en el sistema para organizar los productos.</p>
        </div>

        <!-- PANEL DEL FORMULARIO -->
        <div class="data-panel">
            <h3>Registrar Nueva Categoría</h3>
            <p>Complete los datos para crear la nueva categoría.</p>

            <!-- El atributo action apuntará a nuestro futuro Controlador -->
            <form action="index.php?controller=categoria&action=guardarCategoria" method="POST">
